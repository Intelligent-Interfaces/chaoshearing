...
To minimize free energy, the system completely dismisses the ambiguity and resolves the posterior almost entirely in the direction of the prior (Figure~\ref{fig:psychiatry}, middle). The individual confidently hears a specific source---perhaps a voice or a threat---that is not actually present in the acoustic signal. The hallucination is the brain's optimal response to resolving high-entropy noise under a broken precision-weighting mechanism.
